...
const examSets = {
  "38": [
  {
    ...
    "answer": 1,
    "explanations": {
      "0": "バンク-ミケルセンは確かに<ruby>ノーマライゼーション<rt>のーまらいぜーしょん</rt></ruby>の先駆者ですが、「<ruby>ソーシャルロール・バロリゼーション<rt>そーしゃるろーる・ばろりぜーしょん</rt></ruby>」を提唱したのはヴォルフェンスベルガーです。",
      "1": "正解。ニィリエは、<ruby>ノーマライゼーション<rt>のーまらいぜーしょん</rt></ruby>（normalization）の8つの原理を提唱し、障害者や高齢者が通常の生活様式を送ることを支援する理論を展開しました。",
      "2": "ヴォルフェンスベルガーが提唱したのは「<ruby>ソーシャルロール・バロリゼーション<rt>そーしゃるろーる・ばろりぜーしょん</rt></ruby>」であり、「エーデル改革」ではありません。",
      "3": "リッチモンドが提唱したのは「ケースワークの基本原則」であり、「7原則」ではなく、ソーシャルワークの基礎を作った人物です。",
      "4": "エリクソンは発達心理学者で、<ruby>ライフサイクル<rt>らいふさいくる</rt></ruby>理論を提唱しました。自立生活運動の理念は他の実践者によるものです。"
    }
  },
  {
    ...
    "answer": 3,
    "explanations": {
      "0": "Aさんの意思は確かに大切ですが、この状況では妻の気持ちをどう対応するかが課題です。妻の考えを聞き出し、夫との話し合いをサポートすることが重要です。",
      "1": "医師に決めてもらうのではなく、本人と家族の間での対話が必要です。<ruby>介護職<rt>かいごしょく</rt></ruby>として<ruby>調整役<rt>ちょうせいやく</rt></ruby>を務めることが大切です。",
      "2": "妻の意向をそのまま押し付けるのではなく、夫の意思を尊重しながら本人と妻の気持ちを理解できるようサポートする必要があります。",
      "3": "正解。<ruby>ホームヘルパー<rt>ほーむへるぱー</rt></ruby>は、本人と家族が対話する時間を作り、互いの気持ちを理解し、合意できる解決策を見つけるのをサポートすることが最も適切です。これは介護職の倫理的責任です。",
      "4": "情報提供も重要ですが、まず本人と家族の間での対話を優先すべきです。その後、必要に応じて情報提供を行うことが順序として適切です。"
    }
  },
  {
    ...
    "answer": 2,
    "explanations": {
      "0": "介護ロボットの導入により、人員配置基準が撤廃されることはありません。法的に定められた人員配置基準は変わりません。",
      "1": "介護ロボットの使用方法は、個人の判断ではなく、施設のマニュアルや基準に従う必要があります。統一された使用方法が重要です。",
      "2": "正解。介護ロボットの導入により、利用者の<ruby>自立<rt>じりつ</rt></ruby>支援（例：<ruby>リハビリテーション<rt>りはびりてーしょん</rt></ruby>支援）や生活の質の向上が期待されます。これがロボット導入の主な目的です。",
      "3": "介護ロボットの目的は職員と利用者のかかわりを減らすことではなく、人間関係を保ちながら介護業務を効率化することです。",
      "4": "介護ロボット導入後でも、職員の<ruby>巡回<rt>じゅんかい</rt></ruby>・見守りは重要です。技術がすべての業務を代替することはできません。"
    }
  },
  {
